...
module.exports = {
    ...
    // Direct method exports (bind to the instance)
    createSuccessResponse: responseBuilder.createSuccessResponse.bind(responseBuilder),
    createErrorResponse: responseBuilder.createErrorResponse.bind(responseBuilder),
    createPaginatedResponse: responseBuilder.createPaginatedResponse.bind(responseBuilder),
    createMediaResponse: responseBuilder.createMediaResponse.bind(responseBuilder),
    createTextResponse: responseBuilder.createTextResponse.bind(responseBuilder),
    createListResponse: responseBuilder.createListResponse.bind(responseBuilder),
    createFileDownloadResponse: responseBuilder.createFileDownloadResponse.bind(responseBuilder),
    createAIResponse: responseBuilder.createAIResponse.bind(responseBuilder),
    createSettingsResponse: responseBuilder.createSettingsResponse.bind(responseBuilder),
    wrapAsync: responseBuilder.wrapAsync.bind(responseBuilder),
    isValidResponse: responseBuilder.isValidResponse.bind(responseBuilder),
    mergeResponses: responseBuilder.mergeResponses.bind(responseBuilder),
    createRedirectResponse: responseBuilder.createRedirectResponse.bind(responseBuilder),
    createEmptyResponse: responseBuilder.createEmptyResponse.bind(responseBuilder),
    createValidationErrorResponse: responseBuilder.createValidationErrorResponse.bind(responseBuilder),
    createRateLimitResponse: responseBuilder.createRateLimitResponse.bind(responseBuilder)
};
